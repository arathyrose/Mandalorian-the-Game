...
def setup(difficulty):
    if(difficulty==1):
        ...
        print("Good choice")
        TO_SHIFT_SCREEN_TIME = 0.2
    elif(difficulty==3):
        print("Practice makes man perfect")
        global_stuff.test_enemy=1
    global_stuff.TO_SHIFT_SCREEN = global_stuff.TO_SHIFT_SCREEN_TIME / global_stuff.FRAME_TIME
    # TOTAL TIME THINGS
    global_stuff.TOTAL_TIME = global_stuff.enemy_comes_after*2*global_stuff.screen_length*global_stuff.TO_SHIFT_SCREEN_TIME
